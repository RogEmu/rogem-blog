...
## What is RogEm?
RogEm is a light PSX emulator written in C++ currently in active development.
The project stemmed from a will to learn computer architecture and how hardware interacts with software at a low-level.
...
## Inspiration
We take a lots of our inspiration from already well established emulators such as [duckstation](https://duckstation.org/) or [PCSX Redux](https://pcsx-redux.consoledev.net/) and also from the amazing [documentation](https://psx-spx.consoledev.net/) initially written by Martin "noca$h" Korth
